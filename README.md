...
- [astro-theme-resume](https://github.com/srleom/astro-theme-resume) for website template
...
To edit the homepage content and design, edit the `src/pages/index.astro` file.
